...
public final class Event<E, T> {
  ...
  /**
   * The function used to aggregate multiple values if a computation is dispatched to more then one
   * handler using {@link EventPolicy#isAggregatedMultiDispatch()}.
   */
