...
/**
 * The {@link RoundRobinDispatch} tries to use all available {@link ActionSite} equally often.
 *
 * <p>This basic implementation does not have any particular guarantees of fairness in the presence
 * of a changing list due to dynamic connects and disconnects.
 */
public final class RoundRobinDispatch<A, B> implements ActionDispatch<A, B> {
