...
class TestAssertCompare {
  ...
  private static <T extends Comparable<T>> void assertGeThrows(
  ...
  private static <T extends Comparable<T>> void assertGtThrows(
      T expected, T actual, String expectedMessage) {
    assertCompareThrows(
        Assertions::assertGreaterThan,
        Assertions::assertGreaterThan,
  ...
  private static <T extends Comparable<T>> void assertLtThrows(
      T expected, T actual, String expectedMessage) {
    assertCompareThrows(
        Assertions::assertLessThan,
        Assertions::assertLessThan,
  ...
  private static <T extends Comparable<T>> void assertLeThrows(
      T expected, T actual, String expectedMessage) {
    assertCompareThrows(
        Assertions::assertLessThanOrEqual,
        Assertions::assertLessThanOrEqual,
