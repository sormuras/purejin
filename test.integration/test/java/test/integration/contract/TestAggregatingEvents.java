...
class TestAggregatingEvents {
  ...
  private static class TestAggregatingEventsModule extends ContractModule {
    ...
    protected void declare() {
      ...
      bind(PolicyProvider.class)
          .to(
              handler -> {
                return EventPolicy.DEFAULT.with(Flags.MULTI_DISPATCH_AGGREGATED);
              });
    }
  }

  private final Injector injector = Bootstrap.injector(TestAggregatingEventsModule.class);
