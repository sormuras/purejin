 ...
 *
 * <p>This test only validates the expected output but does not care about the processing
 * restrictions that control correct processing of events with regards to isolation/threading.
 */
