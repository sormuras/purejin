...
class TestExceptionHandlingComputeEvents {
  ...
  private static final class TestExceptionHandlingComputeEventsModule extends ContractModule {
  ...
  private final Injector injector =
      Bootstrap.injector(TestExceptionHandlingComputeEventsModule.class);
  ...
  private static void assertException(
      Class<? extends Exception> type, String msg, Callable<?> test) {
    try {
      test.call();
    } catch (Exception e) {
