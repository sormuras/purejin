 ...
 *
 * <p>A {@link Supplier} is the main "backend" (internal) abstraction to generate or yield instances
 * of the type supplied by the {@link Supplier}. Their user-facing "frontend" counterpart is the
 * {@link se.jbee.inject.Generator}.
 *
 * <p>While {@link Supplier}s stay inaccessible for the user of the {@link Injector} context the
 * {@link se.jbee.inject.Generator}s that act as an facade for their internal {@link Supplier} can
 * be resolved by users like any other dependency.
 *
...
class TestBasicSupplierBinds {
  ...
  private final Injector context = Bootstrap.injector(TestBasicSupplierBindsModule.class);
