...
/**
 * Test that demonstrates how {@link Injector.Observer} can be bound to track the order of instance
 * creation during the bootstrapping of an application tree here simulated by types A, B and C.
 *
 * <p>This sort of thing can be used to later tear down such instances in reverse order.
 */
class TestBasicInjectorObserverBinds {
  ...
  private Injector context = Bootstrap.injector(TestBasicInjectorObserverBindsModule.class);
