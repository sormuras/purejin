...
/**
 * Very simple demo of the {@link se.jbee.inject.ScopeLifeCycle}s that help to detect scoping
 * errors, such as trying to inject an instance in {@link Scope#injection} into another one in
...
class TestBasicScopedBinds {
  ...
  private final Injector context = Bootstrap.injector(TestBasicScopedBindsModule.class);
