...
/**
 * A test that demonstrates how install {@link DefaultFeature#LOGGER} so that each class gets its
 * class-specific- {@link Logger} injected.
 *
 * <p>This is also meant as a template to learn how to implement a similar feature for another
 * logging framework. Just have a look at how the {@link BinderModule} implementing the {@link
 * DefaultFeature#LOGGER} toggle is implemented.
 */
