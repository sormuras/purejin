...
/**
 * This illustrates how to use different named instances for the same interface that are all
 * implemented by the same class without having them linked to the same instance.
 */
class TestExampleInterfaceDecouplingBinds {
  ...
  void instancesAreAllDifferentButUseTheSameInterface() {
    Injector injector = Bootstrap.injector(TestExampleInterfaceDecouplingBindsModule.class);
