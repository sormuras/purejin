 ...
 *
 * <p>The default way however to enable primitive array support is to install {@link
 * DefaultFeature#PRIMITIVE_ARRAYS} which by default is not installed as part of the {@link
 * Bootstrapper#installDefaults()} as it is shown in {@link TestBasicPrimitiveArrayBridgeBinds}.
 *
...
class TestBasicCustomPrimitiveArrayBinds {
  ...
  /** A {@link Supplier} like this would be needed for each of the primitive types. */
