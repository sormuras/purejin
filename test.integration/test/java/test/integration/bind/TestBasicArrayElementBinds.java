 ...
 * defining the elements of them explicitly using the {@link TypedElementBinder#toElements(Hint[])}
 * methods.
 */
class TestBasicArrayElementBinds {
  ...
  private final Injector injector = Bootstrap.injector(TestBasicArrayElementBindsModule.class);
