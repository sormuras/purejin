...
class TestType {
  ...
  void toStringPrintsFullyQualifiedGenericType() throws Exception {
    ...
    l = raw(List.class).parameterized(raw(String.class).asUpperBound());
    assertEquals("java.util.List<? extends java.lang.String>", l.toString());

    l = raw(List.class).parameterized(raw(String.class)).parameterizedAsUpperBounds();
    assertEquals("java.util.List<? extends java.lang.String>", l.toString());
  ...
  void isAssignableToWith1Generic() {
    ...
    assertTrue(listOfIntegers.isAssignableTo(listOfNumbers.parameterizedAsUpperBounds()));
    assertFalse(listOfNumbers.isAssignableTo(listOfIntegers.parameterizedAsUpperBounds()));
  }

  @Test
  void isAssignableToWith2Generics() {
    Type<List> listOfClassesOfIntegers =
        raw(List.class).parameterized(raw(Class.class).parameterized(Integer.class));
    Type<Class> classOfNumbers = raw(Class.class).parameterized(Number.class);
    Type<List> listOfClassesOfNumbers = raw(List.class).parameterized(classOfNumbers);
    assertFalse(listOfClassesOfIntegers.isAssignableTo(listOfClassesOfNumbers));
    assertFalse(
        listOfClassesOfIntegers.isAssignableTo(
            listOfClassesOfNumbers.parameterizedAsUpperBounds()));
    Type<List> listOfExtendsClassesOfExtendsNumbers =
        listOfClassesOfNumbers.parameterized(
  ...
  void definiteTypesAreMoreQualifiedThanTheirThanUpperBound() {
    assertMoreQualified(raw(Integer.class), raw(Integer.class).asUpperBound());
  }
  ...
  void subtypesAreMoreQualifiedThanTheirSupertypesWhenUsedAsGeneric() {
    assertMoreQualified(
        raw(List.class).parameterized(Integer.class), raw(List.class).parameterized(Number.class));
  }

  @Test
  void definiteGenericTypesAreMoreQualifiedThanTheirRawTypes() {
    assertMoreQualified(raw(List.class).parameterized(Integer.class), raw(List.class));
  }
  ...
  void definiteGenericTypesAreMoreQualifiedThanTheirWildcardTypes() {
    assertMoreQualified(
        ...
        raw(List.class).parameterized(Integer.class).parameterizedAsUpperBounds());
  }

  @Test
  void subtypesWithGenericIsMoreQualifiedThanItsSubpertypeWithSameGeneric() {
    assertMoreQualified(
        raw(ArrayList.class).parameterized(Integer.class),
        raw(List.class).parameterized(Integer.class));
  }
  ...
  void genericSuperInterfacesAreContainedInSupertypes() {
    assertContains(
        raw(Integer.class).supertypes(), raw(Comparable.class).parameterized(Integer.class));
  }

  @Test
  void typeVariableSuperInterfacesAreContainedInSupertypes() {
    assertContains(
        raw(List.class).parameterized(String.class).supertypes(),
  ...
  void typeVariableSuperInterfacesOfRawTypesUseWildcardsInSupertypes() {
    assertContains(
        raw(List.class).supertypes(), raw(Collection.class).parameterized(Type.WILDCARD));
  }
  ...
  void typeVariablesAreContainedResolvedInSupertypes() {
    Set<Type<? super Bar>> supertypes =
        raw(Bar.class).parameterized(Integer.class, Float.class).supertypes();
    assertContains(supertypes, raw(Foo.class).parameterized(Float.class, String.class));
    assertContains(supertypes, raw(Baz.class).parameterized(Integer.class));
    assertContains(supertypes, raw(QuxQux.class).parameterized(Float.class));
    assertEquals(
  ...
  void comparableSupertypeOfIntegerIsComparableInteger() {
    assertTrue(
        raw(Integer.class)
            .toSuperType(Comparable.class)
            .equalTo(raw(Comparable.class).parameterized(Integer.class)));
  }
  ...
  void typeComparisonIsDoneBasedOnTheCommonType() {
    ...
    assertTrue(
        raw(XList.class).parameterized(Integer.class, String.class).isAssignableTo(stringList));
    assertFalse(
        raw(XList.class).parameterized(String.class, Integer.class).isAssignableTo(stringList));
  }
  ...
  void upperBoundOfParameterizedTypesIsChecked() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> listType.parameterized(Object.class, Object.class));
  }
  ...
  void rawTypeCanBeCastToAnySupertype() {
    ...
    assertNotNull(rawArrayList.castTo(raw(List.class).parameterized(Integer.class)));
    assertNotNull(
        rawArrayList.castTo(
            raw(List.class).parameterized(Integer.class).parameterizedAsUpperBounds()));
  }
  ...
  void parameterizedTypeCanBeCastToWildcardSupertypes() {
    assertNotNull(
        raw(ArrayList.class)
            .parameterized(Integer.class)
            .castTo(raw(List.class).parameterized(Number.class).parameterizedAsUpperBounds()));
  }

  @Test
  void actualTypeArguments() throws Exception {
    assertToStringEquals(
        "{X=? extends java.io.Serializable, E=?}", classType(XList.class).actualTypeArguments());
    assertToStringEquals(
        "{X=java.lang.String, E=java.lang.Integer}",
        raw(XList.class).parameterized(String.class, Integer.class).actualTypeArguments());
    assertToStringEquals(
        "{X=java.lang.String, E=?}",
        returnType(getClass().getMethod("typeVariableWithActualTypeArgument"))
            .actualTypeArguments());
    assertToStringEquals(
        "{X=? extends java.lang.Number, E=java.lang.Integer}",
        returnType(getClass().getMethod("typeVariableWithActualTypeArgument2"))
            .actualTypeArguments());
  }
  ...
  @Test
  void actualTypeOfMethodReturnTypeWithTypeLevelTypeParameter() throws Exception {
    Type<SimpleMap> actualMapType =
        raw(SimpleMap.class) //
            .parameterized(String.class, Integer.class);

    Method get = SimpleMap.class.getMethod("get", Object.class);
    assertEquals(raw(Integer.class), Type.actualReturnType(get, actualMapType));

    Method keys = SimpleMap.class.getMethod("keys");
    assertEquals(
        raw(Set.class).parameterized(String.class), Type.actualReturnType(keys, actualMapType));
  }

  @Test
  void actualTypeOfParameterTypeWithTypeLevelTypeParameter() throws Exception {
    Type<SimpleMap> actualMapType =
        raw(SimpleMap.class) //
            .parameterized(String.class, Integer.class);
    ...
    assertEquals(
        raw(String.class), Type.actualParameterType(put.getParameters()[0], actualMapType));
    assertEquals(
        raw(Integer.class), Type.actualParameterType(put.getParameters()[1], actualMapType));
  }

  @Test
  void actualTypeOfFieldTypeWithTypeLevelTypeParameter() throws Exception {
    Type<SimpleMapImpl> actualMapType =
        raw(SimpleMapImpl.class) //
            .parameterized(String.class, Integer.class);

    Field values = SimpleMapImpl.class.getDeclaredField("values");
    assertEquals(
        raw(Map.class).parameterized(String.class, Integer.class),
        Type.actualFieldType(values, actualMapType));
  }

  @Test
  void actualInstanceTypeWithoutGenericsIsRawInstanceType() {
    assertEquals(raw(String.class), actualInstanceType("Hello", raw(String.class)));
  }

  @Test
  void actualInstanceTypeWithoutGenericsAsInterfaceIsRawInstanceType() {
    assertEquals(raw(String.class), actualInstanceType("Hello", raw(CharSequence.class)));
  }

  @Test
  void actualInstanceTypeWithoutGenericsAsSupertypeIsRawInstanceType() {
    assertEquals(raw(String.class), actualInstanceType("Hello", raw(Object.class)));
  }
  ...
  void actualInstanceTypeWithGenericsIsNotYetSupported() {
    ...
    assertThrows(UnsupportedOperationException.class, () -> actualInstanceType(obj, actualType));
  }
  ...
  void recursiveTypesDoNotCauseStackOverflow() {
    assertEquals(
        "test.integration.api.TestType.RecursiveType<? extends"
            + " test.integration.api.TestType.RecursiveType<?>>",
