...
class TestSerializable {
  ...
  void injectionIsSerializable() {
    assertSerializable(
        new Injection(
            Instance.anyOf(String.class), Locator.locator(String.class), ScopeLifeCycle.ignore));
  }
  ...
  private static Serializable deserialize(byte[] b) throws IOException, ClassNotFoundException {
