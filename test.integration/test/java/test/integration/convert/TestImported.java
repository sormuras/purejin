...
class TestImported {
  ...
  void wildcardGenericType() {
    assertResolved("List<? extends Number>", "java.util.List<? extends java.lang.Number>");
  }

  @Test
  void wildcardNestedGenericType() {
    assertResolved(
        "Function<String, List<? extends Number>>",
  ...
  void singleNestedGeneric() {
    assertResolved("List<List<String>>", "java.util.List<java.util.List<java.lang.String>>");
  }
  ...
  private void assertError(String input, String expectedError) {
    Exception ex = assertThrows(IllegalArgumentException.class, () -> imported.resolve(input));
