...
class TestConvertTo {
  ...
  public static final class ExampleConverter implements Converter<Integer, BigInteger> {
  ...
  private static <A, B> void assertConverts(
      ConvertTo<B> convertTo, Class<A> type, A input, B expected) {
