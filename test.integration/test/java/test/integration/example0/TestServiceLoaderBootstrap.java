...
/**
 * Small test to check that {@link Bootstrap#currentEnv()} and {@link Bootstrap#currentInjector()}
...
class TestServiceLoaderBootstrap {
  ...
  void serviceLoaderInjectorUsesServiceLoaderEnv() {
    assertSame(Bootstrap.currentEnv(), Bootstrap.currentInjector().resolve(Env.class));
  }
}
