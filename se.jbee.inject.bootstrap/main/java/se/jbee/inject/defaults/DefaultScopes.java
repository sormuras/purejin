...
/**
 * Binds implementations for the standard {@link Scope}s declared as {@link Name} in the {@link
 * Scope} class.
 */
public final class DefaultScopes extends BinderModule {
  ...
  protected void declare() {
    ...
    per(Scope.worker)
        .bind(Scope.Controller.forScope(Scope.worker))
        .toGenerator(gen -> null); // dummy generator as the scope will supply
