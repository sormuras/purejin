/**
 * Contains the fluent {@link se.jbee.inject.binder.Binder} API used by software modules to issue
 * their bindings in a convenient way.
 *
 * <p>In multi-module application this is usually required by each module to bind the services
