...
/**
 * The default utility {@link Bundle} that is a {@link Bootstrapper} as well so that bindings can be
 * declared nicer.
 */
public abstract class BootstrapperBundle implements Bundle, Bootstrapper {
  ...
  protected final <O extends Enum<O> & Dependent<O>> void installAll(Class<O> optionsOfType) {
    install(optionsOfType.getEnumConstants());
  }

  protected final <O extends Enum<O> & Dependent<O>> void uninstallAll(Class<O> optionsOfType) {
