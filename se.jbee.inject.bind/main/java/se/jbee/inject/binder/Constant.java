...
/**
 * A {@link Constant} is the {@link ValueBinder} expansion wrapper type for any constant bound to in
...
public final class Constant<T> implements Descriptor {
  ...
  /**
   * True in case the {@link Scope} and its effects should be applied, else false. By default
   * constants are assumed to be value types that are not scoped.
   */
