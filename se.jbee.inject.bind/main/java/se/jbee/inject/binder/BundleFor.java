 ...
 */
public abstract class BundleFor<E> implements Dependent<E>, Bootstrapper.DependentBootstrapper<E> {
  ...
  /**
   * Use {@link DependentBootstrapper#installDependentOn(Object, Class)} for option dependent {@link
   * Bundle} installation.
   */
