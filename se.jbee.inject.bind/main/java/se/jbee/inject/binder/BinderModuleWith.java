 ...
 *
 * <p>A {@link BinderModuleWith} is also a {@link Bundle} so it should be used and installed as
 * such. It will than {@link Bundle#bootstrap(Bootstrapper)} itself as a module.
 */
public abstract class BinderModuleWith<T> extends AbstractBinderModule implements ModuleWith<T> {
   ...
   * @param property The value contained from the {@link Env} by type or the annotated {@link Class}
   *     in case this {@link ModuleWith} defines the effects of a custom {@link Annotation}.
   */
