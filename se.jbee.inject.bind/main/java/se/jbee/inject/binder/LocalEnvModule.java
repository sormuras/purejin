...
/**
 * A {@link EnvModule} where all made binds (by default) only apply to the package of the extending
 * class and all its sub-packages.
 *
 * <p>This merely exists for clarity and convenience and as a way to learn how to create a package
 * localised effect.
 */
