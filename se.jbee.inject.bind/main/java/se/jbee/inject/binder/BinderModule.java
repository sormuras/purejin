 ...
 *
 * <p>A {@link BinderModule} is also a {@link Bundle} so it should be used and installed as such. It
 * will than {@link Bundle#bootstrap(Bootstrapper)} itself as a module.
 */
public abstract class BinderModule extends AbstractBinderModule implements Module {
  ...
  public final void bootstrap(Bootstrapper bootstrap) {
    if (installDefaults()) bootstrap.installDefaults();
    if (basis != null) bootstrap.install(basis);
  ...
  /**
   * Override this to customise the {@link Env} used within this {@link BinderModule}.
   *
   ...
   * @return fluent API to invoke one of the {@code to} methods to provide the {@link Scope} or the
   *     indirection creating it.
   */
