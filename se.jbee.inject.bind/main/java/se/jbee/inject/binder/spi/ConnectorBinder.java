...
public interface ConnectorBinder {
  ...
  /**
   * The qualifier {@link Name} used in the {@link Env} for a special {@link ProducesBy} used in
   * connection with {@link Connector}. If no special {@link ProducesBy} is set the default named
   * one is used.
   */
