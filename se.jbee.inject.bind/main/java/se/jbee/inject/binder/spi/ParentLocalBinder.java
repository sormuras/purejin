...
/**
 * Make a binding local to the parent {@link Instance} of the currently injected bean.
 *
 * <p>Multiple calls to {@link #within(Instance)} (and its variants) can be used to make the binding
 * to a parent hierarchy.
 *
 * @since 8.1
...
public interface ParentLocalBinder<B> {
  ...
  /**
   * Makes all bindings made with the returned binder local to the provided parent instance.
   *
  ...
  /**
   * Makes all bindings made with the returned binder local to any parent having the provided type.
   *
