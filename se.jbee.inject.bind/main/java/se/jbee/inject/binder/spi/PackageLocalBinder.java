...
/**
 * Make a binding local to a specific package. This means the binding only applies for an injection
 * if the injected bean class is defined within the packages declared.
 *
 * @since 8.1
...
public interface PackageLocalBinder<B> {
  ...
  /**
   * Make all bindings made with the returned binder local to the provided set of {@link Packages}.
   *
   * @param packages a set of {@link Packages} all following binding should apply to
