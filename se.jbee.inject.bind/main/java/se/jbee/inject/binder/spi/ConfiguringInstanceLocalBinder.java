...
/**
 * Makes a configuration binding. Any configuration is local to a target {@link Instance}.
 *
 * @since 8.1
 * @param <B> return type of the binder step following a {@code configure} step
 */
@FunctionalInterface
public interface ConfiguringInstanceLocalBinder<B extends ParentLocalBinder<B>>
    extends InstanceLocalBinder<B> {
