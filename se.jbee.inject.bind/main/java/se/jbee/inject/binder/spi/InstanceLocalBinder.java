 ...
 *
 * <p>Usually this is used to specify what parameter to use when injecting the target instance.
 *
 * @since 8.1
 * @param <B> return type of the binder step following a {@code injectingInto} step
 */
@FunctionalInterface
public interface InstanceLocalBinder<B> {

  /**
   * Makes all bindings made with the returned binder local to the injection of the provided {@link
   * Instance}, in other words when dependencies of that {@link Instance} are resolved.
   *
