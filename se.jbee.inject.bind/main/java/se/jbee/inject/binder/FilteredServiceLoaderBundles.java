...
public abstract class FilteredServiceLoaderBundles extends BootstrapperBundle {
  ...
  /**
   * In the instance of {@link Bundle}s composition isn't as meaningful as in most other contexts as
   * {@link Bundle} are purely identified by {@link Class}. This means two instances of the same
   * {@link Bundle} implementation with different inner state make no sense. Therefore we do use
