...
public final class Schedule {
  ...
  // TODO maybe rather have callbacks like: onRunFailed(Exception ex, ExecutionControl control);
  // where control allows to e.g. cancel the execution and such things
  ...
  public Schedule(
      ...
      int cancelAfterConsecutiveFailedRuns) {
  ...
  public String toString() {
    return String.format(
        "%s[%s] every %s from %s", getClass().getSimpleName(), scheduled, interval, firstRun);
  }
}
