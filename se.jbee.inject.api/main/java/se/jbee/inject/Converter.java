...
public interface Converter<A, B> {
  ...
  /**
   * Converts input to the corresponding value of the output type of this {@link Converter}.
   *
   * @param input any value including {@code null}
   * @return output value including {@code null}
   * @throws IllegalArgumentException In case the input value cannot be converted to the output type
   */
  B convert(A input);
